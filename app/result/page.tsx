        ...
        <div className="result-main">
                ...
                <div key={s.trait} style={{ marginBottom: 20 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <span style={{ fontWeight: 700, color: info.color }}>{info.name.en}</span>
              ...
              return (
                <div key={t} className="trait-detail-card">
                  ...
                  <div style={{ marginBottom: 12 }}>
                    <p style={{ fontSize: 12, fontWeight: 700, color: "#0f2942", marginBottom: 6 }}>Top Skills</p>
                  ...
                  <div style={{ marginBottom: 12 }}>
                    <p style={{ fontSize: 12, fontWeight: 700, color: "#0f2942", marginBottom: 6 }}>Best Career Paths</p>
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                      {info.jobs.en.map((j) => (
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    <p style={{ fontSize: 12, color: "#5b8db8" }}>
                      <span style={{ fontWeight: 700, color: "#0f2942" }}>Best Friends: </span>
                      {info.friendTraits.en}
                    </p>
                    <p style={{ fontSize: 12, color: "#5b8db8" }}>
                      <span style={{ fontWeight: 700, color: "#0f2942" }}>Ideal Partner: </span>
          ...
          <div className="card" style={{ marginBottom: 16 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                { level: "High (65-100%)",  desc: "This trait is strongly present in your personality.",    color: "#0e9b8a" },
                { level: "Medium (35-64%)", desc: "This trait is moderately expressed in your personality.", color: "#1a7abf" },
                { level: "Low (0-34%)",     desc: "This trait is less dominant in your personality.",        color: "#2e6da4" },
              ].map((item) => (
                <div key={item.level} style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                  ...
                  <p style={{ fontSize: 13, color: "#5b8db8" }}>{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
